...
crepeSalee = document.querySelector(".crepe_salee")
...
poff = document.querySelector(".poffs")
...
indexPoff = document.getElementById("present_poffs")
indexPoff.addEventListener("click",(e)=>{
    e.preventDefault();
    console.log("coucou");
    affiche = document.querySelector("#carte")
...
indexCrepe = document.getElementById("index_crepe")
indexCrepe.addEventListener("click",(e)=>{
    e.preventDefault()
    affiche = document.querySelector("#carte")
